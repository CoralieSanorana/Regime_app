...
<?= view('header', ['activeMenu' => 'gold']) ?>
    ...
    <div class="page active" id="pg-gold">
      <div class="page-header">
        <h1>Option Gold <svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#star-fill') ?>"></use></svg></h1>
      ...
      <div class="gold-promo">
        <div class="gold-crown"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#crown') ?>"></use></svg></div>
        <div class="gold-promo-content">
          ...
          <?php if(!empty($is_gold) && (int) $is_gold === 1): ?>
            <span class="badge badge-gold"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#star-fill') ?>"></use></svg> GOLD ACTIF</span>
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="grid-3">
        <div class="card" style="border-color:rgba(245,158,11,0.2);">
          <div style="font-size:2rem;margin-bottom:12px;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#wallet2') ?>"></use></svg></div>
        ...
        <div class="card" style="border-color:rgba(245,158,11,0.2);">
          <div style="font-size:2rem;margin-bottom:12px;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#bullseye') ?>"></use></svg></div>
        ...
        <div class="card" style="border-color:rgba(245,158,11,0.2);">
          <div style="font-size:2rem;margin-bottom:12px;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#bar-chart') ?>"></use></svg></div>
      ...
      <div style="margin-top:24px;padding:24px;background:var(--surface);border:1px dashed rgba(245,158,11,0.25);border-radius:var(--radius);text-align:center;">
        ...
        <div style="font-size:0.85rem;color:var(--text-muted);margin-bottom:16px;">Paiement unique — Accès à vie · Remboursable sur le porte-monnaie IT-enForme</div>
  ...
  <span class="notif-icon"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#check2-circle') ?>"></use></svg></span>
