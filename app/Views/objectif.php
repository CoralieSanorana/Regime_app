...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @media (max-width: 900px) {
    ...
    /* ============ FOOTER FIXE UNE LIGNE ============ */
    .app-footer {
        position: fixed;
        bottom: 0;
        left: 280px; /* Aligné sur ta sidebar */
        right: 0;
        height: 50px; /* Plus fin pour une seule ligne */
    ...
    .footer-line {
        ...
        color: var(--text-muted);
        font-size: 0.85rem;
        white-space: nowrap; /* Force le contenu sur une seule ligne */
    }
    ...
    @media (max-width: 768px) {
        ...
        .footer-mission {
            display: none; /* On cache la mission sur petit écran pour garder une ligne */
        }
    }
