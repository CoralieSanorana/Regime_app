...
<div class="page active" id="pg-objectif">
    ...
    <div style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
      ...
      <div style="position: relative; width: 140px; height: 140px; flex-shrink: 0;">
        <svg id="imc-ring-objectif" width="140" height="140" viewBox="0 0 140 140" style="filter: drop-shadow(0 0 15px rgba(74, 222, 128, 0.3)); position: absolute; top: 0; left: 0;">
          ...
          <circle id="imc-ring-progress-objectif" cx="70" cy="70" r="60" fill="none" stroke="#4ade80" stroke-width="12" stroke-dasharray="260 376.99" stroke-linecap="round" stroke-dashoffset="0"/>
        </svg>
      ...
      <div>
        ...
        <div id="imc-status-objectif" style="font-size: 0.92rem; margin-bottom: 8px; color: #4ade80;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#check2-circle') ?>"></use></svg> IMC Sain</div>
  ...
  <div class="card" style="margin-bottom: 2rem;">
    <div class="card-title" style="margin-bottom: 1.5rem; font-weight: 600;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#bullseye') ?>"></use></svg> Choisir votre objectif</div>
        ...
        <?php foreach($objectifs as $obj): ?>
          <div class="obj-card" onclick="selectObjectif(this, '<?= addslashes($obj['libelle']) ?>');" style="cursor: pointer;">
            <?php if($obj['libelle'] === 'Perdre du Poids'): ?>
              <div class="obj-emoji"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#graph-down') ?>"></use></svg></div>
            <?php elseif($obj['libelle'] === 'Augmenter son Poids'): ?>
              <div class="obj-emoji"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#graph-up') ?>"></use></svg></div>
            <?php else: ?>
              <div class="obj-emoji"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#speedometer2') ?>"></use></svg></div>
            <?php endif; ?>
  ...
  <div class="card">
    <div class="card-title" style="margin-bottom: 1.5rem; font-weight: 600;"><svg class="bi" aria-hidden="true"><use href="<?= base_url('assets/icones/bootstrap-icons.svg#bullseye') ?>"></use></svg> Définir votre poids cible</div>
